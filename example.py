...
if not controller.connect() or not controller_opponent.connect():
...
while True:
    ...
    if gamestate.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
        ...
        if discovered_port > 0:
            ...
            melee.techskill.multishine(ai_state=gamestate.players[args.opponent], controller=controller_opponent)
        else:
